...
{
	public class CheckDistanceToPickedTeleporter : Conditional
	{
		...
		public CheckDistanceToPickedTeleporter(IComposite composite, string[] param)
		...
		{
			return new CheckDistanceToPickedTeleporter(this, new string[3]
			{
				_rangeType.ToString(),
				_range.ToString(),
		...
		public override BehaviorResult Execute(IBehaviorTreeState state)
		{
			...
			PosWithRot pos = behaviorTreeState.PickedTeleportPoint.Pos;
			switch (_rangeType)
			{
			case AIRangeType.Absolute:
			{
				double valueSrc = VWorldUtil.Distance(pos, behaviorTreeState.Self.Position);
