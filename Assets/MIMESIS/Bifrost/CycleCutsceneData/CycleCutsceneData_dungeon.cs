...
{
	public class CycleCutsceneData_dungeon : ISchema
	{
		public int daycount;
		...
		public CycleCutsceneData_dungeon(uint msgID, string msgName)
			: base(msgID, msgName)
		{
		}

		public CycleCutsceneData_dungeon()
			: base(427831169u, "CycleCutsceneData_dungeon")
		{
		}

		public void CopyTo(CycleCutsceneData_dungeon dest)
		{
		...
		public bool Equal(CycleCutsceneData_dungeon comp)
		{
		...
		public CycleCutsceneData_dungeon Clone()
		{
			CycleCutsceneData_dungeon cycleCutsceneData_dungeon = new CycleCutsceneData_dungeon();
			CopyTo(cycleCutsceneData_dungeon);
			return cycleCutsceneData_dungeon;
		}
