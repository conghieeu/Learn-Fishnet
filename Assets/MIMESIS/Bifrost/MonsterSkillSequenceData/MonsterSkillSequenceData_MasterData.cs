...
{
	public class MonsterSkillSequenceData_MasterData : ISchema
	{
		public int id;
		...
		public MonsterSkillSequenceData_MasterData(uint msgID, string msgName)
			: base(msgID, msgName)
		{
		}

		public MonsterSkillSequenceData_MasterData()
			: base(2222111176u, "MonsterSkillSequenceData_MasterData")
		{
		}

		public void CopyTo(MonsterSkillSequenceData_MasterData dest)
		{
			dest.id = id;
		...
		public bool Equal(MonsterSkillSequenceData_MasterData comp)
		{
			if (id != comp.id)
			{
				return false;
		...
		public MonsterSkillSequenceData_MasterData Clone()
		{
			MonsterSkillSequenceData_MasterData monsterSkillSequenceData_MasterData = new MonsterSkillSequenceData_MasterData();
			CopyTo(monsterSkillSequenceData_MasterData);
			return monsterSkillSequenceData_MasterData;
		}
