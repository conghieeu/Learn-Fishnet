...
{
	public class CharacterSkillSequenceData_MasterData : ISchema
	{
		public int id;
		...
		public int abnormal_trigger_value;
		...
		public CharacterSkillSequenceData_MasterData(uint msgID, string msgName)
			: base(msgID, msgName)
		{
		}

		public CharacterSkillSequenceData_MasterData()
			: base(2904540754u, "CharacterSkillSequenceData_MasterData")
		{
		}

		public void CopyTo(CharacterSkillSequenceData_MasterData dest)
		{
			dest.id = id;
			...
			dest.abnormal_trigger_value = abnormal_trigger_value;
		...
		public int GetLengthInternal()
		{
			...
			num += Serializer.GetLength(abnormal_trigger_value);
		...
		public void LoadInternal(BinaryReader br)
		{
			...
			Serializer.Load(br, ref abnormal_trigger_value);
		...
		public void SaveInternal(BinaryWriter bw)
		{
			...
			Serializer.Save(bw, abnormal_trigger_value);
		...
		public bool Equal(CharacterSkillSequenceData_MasterData comp)
		{
			if (id != comp.id)
			{
				return false;
			...
			if (abnormal_trigger_value != comp.abnormal_trigger_value)
			{
				return false;
			}
		...
		public CharacterSkillSequenceData_MasterData Clone()
		{
			CharacterSkillSequenceData_MasterData characterSkillSequenceData_MasterData = new CharacterSkillSequenceData_MasterData();
			CopyTo(characterSkillSequenceData_MasterData);
			return characterSkillSequenceData_MasterData;
		}
